...
export const metadata: Metadata = { title: 'Pusat Belajar Islam', description: 'Belajar Tazkiyatun Nafs, Fiqh Ibadah, Siroh Nabawiyah, Ilmu Tajwid, dan Ilmu Balaghoh.' };
...
export default function LearningPage() {
  return <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
    <header className="rounded-3xl bg-linear-to-br from-emerald-800 to-teal-950 p-8 sm:p-12 text-white space-y-4">
      ...
      <p className="text-emerald-100 leading-relaxed max-w-2xl">Rawat hati, pelajari ibadah, teladani Rasulullah ﷺ, perbaiki bacaan Al-Qur’an, dan pahami kesesuaian ungkapan. Pilih materi dan belajar sesuai ritmemu.</p>
    </header>
    ...
    <div className="grid gap-4 sm:grid-cols-2"><Link href="/praktik-ibadah" className="block rounded-2xl bg-emerald-700 p-6 text-white font-semibold">Panduan Bergambar Wudhu dan Shalat Nabi</Link><Link href="/panduan-ibadah" className="block rounded-2xl bg-teal-800 p-6 text-white font-semibold">Panduan Jenazah, Yasinan, Haji dan Umrah</Link></div>
