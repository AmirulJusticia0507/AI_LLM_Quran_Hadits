...
Data diambil saat runtime melalui backend, dengan cache memori satu jam dan satu permintaan serentak per kitab. Tidak memerlukan API key atau layanan LLM. Katalog Arab tidak dipotong atau dikonversi menjadi HTML. Pencarian Arab mengabaikan harakat; pencarian numerik cocok tepat pada nomor edisi sumber.
